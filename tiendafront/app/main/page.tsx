...
import { logout, logoutAuth } from '@/modules/close/logout';
...
import { logoutToken } from '@/modules/services/loginApi';

function Main({ params }: CustomId) {
  ...
  const findProducts = async () => {
    ...
    if (pagePro != undefined) {
      try {
        let resopnse: Response | undefined = await findProductPage(pagePro);
        let json;
